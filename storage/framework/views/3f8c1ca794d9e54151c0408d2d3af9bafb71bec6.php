...
<form action="<?php echo e(route('addnewreminder')); ?>" method="POST">
...
<form action="<?php echo e(route('deletethisreminder')); ?>" method="POST">
...
<script type="text/javascript">
	LoadRemindersPage();
 	function LoadRemindersPage(){
 		$.ajax({
 			type: "POST",
 			url: "<?php echo e(route('getremindersbyorigin')); ?>",
