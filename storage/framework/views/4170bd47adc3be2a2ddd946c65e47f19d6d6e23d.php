...
<form action="<?php echo e(route('group_asset')); ?>" method="GET">
...
<script type="text/javascript">
    ...
    function LoadGroupAssetsTools(){
        ...
        $("#mygroupid").val(inp_sc_id);
          $.ajax({
    type: "POST",
    url: "<?php echo e(route('get_roo_gr')); ?>",
    data: {_token:"<?php echo e(csrf_token()); ?>",school_id:inp_sc_id},
    success: function(data){
      $("#allroms").html(data);
    }
  })
  $.ajax({
    type: "POST",
    url: "<?php echo e(route('get_cat_gr')); ?>",
    data: {_token:"<?php echo e(csrf_token()); ?>",school_id:inp_sc_id},
    success: function(data){
      $("#allcats").html(data);
    }
  ...
  function getcountofgen(){
    ...
    $.ajax( {
      type: "POST",
    url: "<?php echo e(route('get_tobegen_repcount')); ?>",
    data: {_token:"<?php echo e(csrf_token()); ?>",rn:roomnum,cc:category_class,station_id:inp_sc_id},
    success: function(data){
...
$.ajax({
    type: "POST",
    url: "<?php echo e(route('get_noscitems')); ?>",
    data: {_token:"<?php echo e(csrf_token()); ?>","station_number":sc_id},
    success: function(data){
