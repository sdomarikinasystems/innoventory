  ...
  <!-- FOR ADMIN ONLY -->
	...
	?>
	 <ul class="nav nav-tabs mb-3 mt-3" id="pills-tab" role="tablist">
	  <li class="nav-item">
	    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"><i class="fas fa-database"></i> <span id="sourcename"><?php echo e(session('user_schoolname')); ?></span></a>
	  </li>
	</ul>
   ...
   $.ajax({
    ...
    function LoadAssets(){
      ...
      $.ajax({
        type : "POST",
        url : "<?php echo e(route('disp_omm_reps')); ?>",
