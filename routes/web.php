...
Route::get('/displaydisposedassets', ['uses' => 'functions@asset_disp_disposed', 'as' => 'asset_disp_disposed']);
Route::get('/getallemployees', ['uses' => 'functions@display_all_employees', 'as' => 'display_all_employees']);
Route::get('/getallscnames', ['uses' => 'functions@load_all_school_names', 'as' => 'load_all_school_names']);
...
Route::get('/get_inf_user', ['uses' => 'functions@get_acc_info_edit', 'as' => 'get_acc_info_edit']);
...
Route::post('/proc_signin', ['uses' => 'functions@proc_sign_protocol', 'as' => 'proc_signin_protocol']);
...
Route::get('/loadallstation', ['uses' => 'functions@load_stat_enc', 'as' => 'load_stat_enc']);
...
Route::get('/get_discrep_indetail', ['uses' => 'functions@lod_dis_indetail', 'as' => 'lod_dis_indetail']);
...
Route::get('/display_reminders_byorigin', ['uses' => 'functions@getremorgi', 'as' => 'getremindersbyorigin']);
...
Route::get('/load_allofmy_assuploads', ['uses' => 'functions@lodresups', 'as' => 'getmyresourcesofassets']);
Route::get('/load_all_resource_bylatest', ['uses' => 'functions@load_res_all_bylatest', 'as' => 'getallreourcesbylatest']);
...
Route::get('/check_if_inventory_ready', ['uses' => 'functions@inventory_checkif_ready', 'as' => 'checinvread']);
Route::get('/get_service_centers_for_qr_filter', ['uses' => 'functions@get_ser_fqrs', 'as' => 'get_ser_of_sta_fo_fil']);
Route::get('/get_qr_assets_by_service_center', ['uses' => 'functions@get_qr_as_sbyer', 'as' => 'Loadqrbyservicecen']);
...
Route::get('/get_missing_semi_data', ['uses' => 'functions@look_get_semi_expendable_not_scanned', 'as' => 'stole_get_semi_expendable_not_scanned']);
...
// QR PRINING PAGE
Route::get('/translate_sdm_securitywise', ['uses' => 'functions@fire_trans_sdm', 'as' => 'shoot_trans_sdm']);
