...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
 ...
 <a class="nav-link" href="#" data-toggle="modal" data-target="#m_generatereport"><i class="fas fa-arrow-right"></i> Generate Report</a>
      ...
      <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
        <i class="fas fa-filter"></i> Filter Asset Source
      </a>
  ...
  function changesource(control_obj){
    ...
    $("#myschool_realid").val($(control_obj).data("sourceid"));
     ...
     if($(control_obj).data("sourceid") != <?php echo session("user_school"); ?>){
            $("#sourcename").html($(control_obj).data("sourcename") + " <button class='btn btn-sm btn-primary' onclick='gotomyownassets()'> <i class='fas fa-sync-alt'></i> Switch to Default</button>");
          }else{
...
<div class="row mt-4">
  <div class="col-md-12">
    <h5 class="mb-4">Asset Registry of <span id="sourcename" title="Change by clicking the 'Filter Asset Source if available on the navigation bar.'"><?php echo e(session("user_schoolname")); ?></span></h5>
  </div>
  <div class="col-md-6">
    <div class="card">
      <div class="card-body">
...
<div class="mt-3">
  <table class=" table table-sm" id="tbl_ass">
  <thead>
    <tr>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Room</label>
            <select class="form-control" id="allroms" name="my_room">
              <option>Sample</option>
            </select>
          </div>
             <div class="form-group">
            <label>Category</label>
            <select class="form-control" id="allcats" name="my_category">
              <option>Sample</option>
            </select>
          </div>
...
<form action="archive_asset" method="POST">
  <?php echo e(csrf_field()); ?>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name ="asset_archive_type">
              <option value="1">Condemnation / Desctruction</option>
         ...
         <div class="row">
          ...
          <div class="form-group">
            <label>Upload Asset Registry CSV File</label><br>
             <input type="file" id="file" required="" name="thecsvfile" onchange="return fileValidation()">
          </div>
           </div>
           <div class="col-md-6">
                <div class="alert alert-success" role="alert">
            <h6 class="card-title">The file to upload must met the requirements below</h6>
            <ol>
              <li>File format need to be <span class="badge badge-success">.CSV</span></li>
              <li>File size is below <span class="badge badge-success">5 MB</span></li>
