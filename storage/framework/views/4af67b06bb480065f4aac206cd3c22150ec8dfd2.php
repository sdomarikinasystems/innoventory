...
<script type="text/javascript">
	...
	function fetchallassets(control_obj){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo e(route('get_grouped_asset_contents')); ?>",
			data: {_token:"<?php echo e(csrf_token()); ?>",column_name:colname,column_value:colvalue},
			success: function(data){
				// alert(data);
	...
	function LoadReportAssetClass(){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo e(route('getrepo')); ?>",
			data: {_token:"<?php echo e(csrf_token()); ?>",columnname:"asset_classification"},
			success: function(data){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo e(route('getrepo')); ?>",
			data: {_token:"<?php echo e(csrf_token()); ?>",columnname:"asset_sub_class"},
			success: function(data){
				// alert(data);
		...
		$.ajax({
			type: "POST",
			url: "<?php echo e(route('getrepo')); ?>",
			data: {_token:"<?php echo e(csrf_token()); ?>",columnname:"current_condition"},
			success: function(data){
...
$.ajax({
			type: "POST",
			url: "<?php echo e(route('getrepo')); ?>",
			data: {_token:"<?php echo e(csrf_token()); ?>",columnname:"source_of_fund"},
			success: function(data){
...
$.ajax({
			type: "POST",
			url: "<?php echo e(route('getrepo')); ?>",
			data: {_token:"<?php echo e(csrf_token()); ?>",columnname:"date_of_acquisition"},
			success: function(data){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo e(route('getrepo')); ?>",
			data: {_token:"<?php echo e(csrf_token()); ?>",columnname:"service_center"},
			success: function(data){
