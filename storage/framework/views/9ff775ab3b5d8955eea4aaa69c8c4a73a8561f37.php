...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(route('assetregistry')); ?>">Asset Registry</a></li>
...
<form action="<?php echo e(route('reportallomassets')); ?>" method="POST">
...
<form action="<?php echo e(route('clear_omass')); ?>" method="POST">
...
<form action="<?php echo e(route('ig_sin_om')); ?>" method="POST">
...
<form action="<?php echo e(route('report_omitted_singleton')); ?>" method="POST">
	<?php echo e(csrf_field()); ?>
...
<script type="text/javascript">
	...
	$.ajax({
		type: "POST",
		url: "<?php echo e(route('get_omitteditems_astable')); ?>",
